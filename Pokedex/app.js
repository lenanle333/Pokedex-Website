...
const displayPokemon = async (page = 1) => {
  let content = "";
  pokedex
    .filter((row, index) => {
    ...
    .forEach((pokemon) => {
      content += `
            ...
            <img class="sprite" src="assets/sprites/${pokemon.id}.png" />
    ...
    .forEach((pokemon) => {
      ...
      switch (pokemon.types[0]) {
        case "ghost":
          ...
          pokemonCard.children[0].style.outline = "#D0B0F8 solid 10px";
          break;
        case "bug":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #C2EFA7 0%, #A0C888 100%)";
          pokemonCard.children[0].style.outline = "#D3F9BC solid 10px";
          break;
        case "flying":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #BCE8F5 0%, #E1E8DD 100%)";
          pokemonCard.children[0].style.outline = "#B8E8F8 solid 10px";
          break;
        case "fairy":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #FFD0FF 0%, #FF96FF 100%)";
          pokemonCard.children[0].style.outline = "#FFC5FF solid 10px";
          break;
        case "poison":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #FEC9FF 0%, #BF61F9 100%)";
          pokemonCard.children[0].style.outline = "#DCAAEE solid 10px";
          break;
        case "grass":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #B9FFA4 0%, #7AB867 100%)";
          pokemonCard.children[0].style.outline = "#B1FA9B solid 10px";
          break;
        case "steel":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #EBEBFF 0%, #B7B7C4 100%)";
          pokemonCard.children[0].style.outline = "#E7E7FF solid 10px";
          break;
        case "fire":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #F8C090 0%, #FF5925 100%)";
          pokemonCard.children[0].style.outline = "#FDD2AA solid 10px";
          break;
        case "electric":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #F6F4CE 0%, #EEE645 100%)";
          pokemonCard.children[0].style.outline = "#F3F3CD solid 10px";
          break;
        case "water":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #E4EDFF 0%, #3E7FFF 100%)";
          pokemonCard.children[0].style.outline = "#CDDDFF solid 10px";
          break;
        case "ground":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #FBF8B9 0%, #9C6F39 100%)";
          pokemonCard.children[0].style.outline = "#F3EBC4 solid 10px";
          break;
        case "dragon":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #A6DAFF 0%, #FF8A9B 100%)";
          pokemonCard.children[0].style.outline = "#FDCED8 solid 10px";
          break;
        case "ice":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #DEFCFE 0%, #6ADBF4 100%)";
          pokemonCard.children[0].style.outline = "#C9FBFE solid 10px";
          break;
        case "rock":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #FFE7B2 0%, #846522 100%)";
          pokemonCard.children[0].style.outline = "#E1CB9A solid 10px";
          break;
        case "fighting":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #FFCDCD 0%, #FF4545 100%)";
          pokemonCard.children[0].style.outline = "#FFC8C8 solid 10px";
          break;
        case "normal":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #F1F1DB 0%, #CCCCBA 100%)";
          pokemonCard.children[0].style.outline = "#E8E8D8 solid 10px";
          break;
        case "dark":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #B8B0B0 0%, #222222 100%)";
          pokemonCard.children[0].style.outline = "#A5A5A5 solid 10px";
          break;
        case "psychic":
          pokemonCard.children[0].style.background =
            "linear-gradient(180deg, #E77779 0%, #FF4EB5 100%)";
          pokemonCard.children[0].style.outline = "#FFD5D5 solid 10px";
          break;
      }
    });
};
